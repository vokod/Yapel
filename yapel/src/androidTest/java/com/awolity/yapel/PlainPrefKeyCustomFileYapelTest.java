...
public class PlainPrefKeyCustomFileYapelTest {
    ...
    public void setup() throws Exception {
        ...
        customFileYapel = new EncryptedPrefKeyYapel("my_key_alias2", instrumentationCtx, "my_preference_file");
    }
    ...
    public void booleanTest() throws Exception {
        boolean value = true;
        customFileYapel.setBoolean(BOOLEAN_KEY, value);
